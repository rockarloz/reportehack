...
class DraggableView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        imageView.image = UIImage(named: "algo.png")
        ...
        panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(DraggableView.beingDragged(gestureRecognizer:)))
